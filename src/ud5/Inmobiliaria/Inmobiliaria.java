//Para que la salida muestre correctamente el símbolo € se debe ejecutar antes del programa el comando chcp 65001
...
public class Inmobiliaria {
    public static void main(String[] args) {
        ...
        System.out.println(piso1.mostrarInfoGeneral());
        System.out.println(casa1.mostrarInfoGeneral());
        System.out.println("");
