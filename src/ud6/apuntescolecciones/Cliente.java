...
public class Cliente implements Comparable<Cliente>{
    ...
    public static void main(String[] args) {
        ...
        clientes.add(new Cliente("34534534Z","Pepe","20/12/2000"));
        clientes.add(new Cliente("34555534Z","Maria","20/12/2000"));
        ...
        System.out.println("IMPRESIÓN CON BUCLE FOR-EACH");
        ...
        System.out.println("IMPRESIÓN CON Iterator");
        ...
        /*
        *Collection<Cliente> clientes2 = new TreeSet<>();
